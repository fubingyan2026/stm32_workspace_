...
void HAL_FDCAN_MspInit(FDCAN_HandleTypeDef* fdcanHandle)
{
  ...
  */
    ...
    PA12     ------> FDCAN1_TX
    */
    GPIO_InitStruct.Pin = POWER_CAN_RXD_Pin|POWER_CAN_TXD_Pin;
  ...
  */
    ...
    PB6     ------> FDCAN2_TX
    */
    GPIO_InitStruct.Pin = BAT2_CAN_RXD_Pin|BAT2_CAN_TXD_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  */
    ...
    PB4     ------> FDCAN3_TX
    */
    GPIO_InitStruct.Pin = BAT1_CAN_RXD_Pin|BAT1_CAN_TXD_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_FDCAN_MspDeInit(FDCAN_HandleTypeDef* fdcanHandle)
{
  ...
  /* USER CODE END FDCAN1_MspDeInit 0 */
    ...
    PA12     ------> FDCAN1_TX
    */
    HAL_GPIO_DeInit(GPIOA, POWER_CAN_RXD_Pin|POWER_CAN_TXD_Pin);
  ...
  /* USER CODE END FDCAN2_MspDeInit 0 */
    ...
    PB6     ------> FDCAN2_TX
    */
    HAL_GPIO_DeInit(GPIOB, BAT2_CAN_RXD_Pin|BAT2_CAN_TXD_Pin);
  ...
  /* USER CODE END FDCAN3_MspDeInit 0 */
    ...
    PB4     ------> FDCAN3_TX
    */
    HAL_GPIO_DeInit(GPIOB, BAT1_CAN_RXD_Pin|BAT1_CAN_TXD_Pin);
