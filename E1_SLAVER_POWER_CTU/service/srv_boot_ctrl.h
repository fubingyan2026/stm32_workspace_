 ...
 * @version V1.0.0
 * @date    2026-09-07
 * @brief   升级跳转控制服务（E1_SLAVER_POWER_CTU → E1_CTU_BOOT）
 * @attention
 *
 * 通过 boot_flash（public_layer/service/boot）向共享 Metadata 区写入
 * upgrade_flag=1 后复位，使 Bootloader 上电进入 RS485 YMODEM 升级模式。
 *
