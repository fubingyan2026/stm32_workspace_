 ...
 * @version V1.0.0
 * @date    2026-09-03
 * @brief   ADC 设备驱动实现（DMA + 通道路由表，E1_SLAVER_POWER_CTU）
 */
 ...
 * DMA 缓冲区索引 = Rank - 1
 *
 * ADC1 (INST_1, 6ch): PC0/PC1/PC2/PC3 + TEMPSENSOR + VREFINT
 *   Rank1..6 = AUX(IN10), MOTOR(IN11), LSD1(IN12), LSD2(IN13),
 *              TEMPSENSOR, VREFINT
 */
static const drv_adc_route_t s_routes[DRV_ADC_CH_MAX] = {
    [DRV_ADC_CH_AUX]       = { DRV_ADC_INST_1, 0 }, /**< PC0, ADC1_IN10, Rank1 */
    [DRV_ADC_CH_MOTOR]     = { DRV_ADC_INST_1, 1 }, /**< PC1, ADC1_IN11, Rank2 */
    [DRV_ADC_CH_LSD1]      = { DRV_ADC_INST_1, 2 }, /**< PC2, ADC1_IN12, Rank3 */
    [DRV_ADC_CH_LSD2]      = { DRV_ADC_INST_1, 3 }, /**< PC3, ADC1_IN13, Rank4 */
    [DRV_ADC_CH_TEMPSENSOR]= { DRV_ADC_INST_1, 4 }, /**< 内部温度传感器, Rank5 */
    [DRV_ADC_CH_VREFINT]   = { DRV_ADC_INST_1, 5 }, /**< 内部参考电压, Rank6 */
};
