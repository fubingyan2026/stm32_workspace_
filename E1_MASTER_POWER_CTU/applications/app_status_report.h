 ...
 * @version V1.0.0
 * @date    2026-09-03
 * @brief   应用层 — 系统状态上报聚合 (E1_MASTER_POWER_CTU)
 *
 * 用例：聚合 srv_pwr_det / srv_adc / srv_fan_ctrl 各服务数据，
 * 填充 srv_com_mst_report_t，供 RS485 主机查询应答。
 ...
 * @note  签名与 srv_com_mst_read_cb_t 一致，可直接注册为 read_data 回调
 */
