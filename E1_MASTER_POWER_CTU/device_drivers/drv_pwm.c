 ...
 * @version V1.1.0
 * @date    2026-09-03
 * @brief   PWM 设备驱动实现（内置通道路由表，多通道通用，E1_MASTER_POWER_CTU）
 */
...
/** @brief TIM4 默认 PWM 频率（组共用：LED 调光 + 双风扇调速） */
#define DRV_PWM_TIM4_DEFAULT_FREQ_HZ (25000U)
 ...
 *   - FAN1_PWM_IO: PB8  → TIM4_CH3
 *   - FAN0_PWM_IO: PB9  → TIM4_CH4
...
static const drv_pwm_route_t s_routes[DRV_PWM_CH_MAX] = {
    ...
    [DRV_PWM_CH_FAN1] = { &htim4, TIM_CHANNEL_3, 72000000U, "FAN1" },
    [DRV_PWM_CH_FAN0] = { &htim4, TIM_CHANNEL_4, 72000000U, "FAN0" },
};
