 ...
 * @version V1.1.0
 * @date    2026-09-03
 * @brief   风扇驱动（PWM 调速 + EXTI 脉冲计数测速，E1_MASTER_POWER_CTU）
 * @attention
 *
 * 硬件配置内置在 drv_fan.c 中，上层无需传递引脚参数。
 * PWM 经 drv_pwm 输出（TIM4 组），FG: EXTI0(PA0) / EXTI1(PA1)。
 * EXTI0/EXTI1 中断向量处理在 Core/Src/stm32f1xx_it.c 的 USER CODE 中实现。
 */
