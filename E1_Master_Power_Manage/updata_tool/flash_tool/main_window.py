...
class MainWindow(QMainWindow):
    APP_NAME = "E1_Master_Power_Manage 固件升级工具"
    ORG_NAME = "E1_Master_Power_Manage"
    ...
    def _on_start_flash(self):
        ...
        config = FlashConfig(
            ...
            boot_request_can_id=cfg_dict["boot_request_can_id"],
            frame_interval_us=cfg_dict["frame_interval_us"],
        )
    ...
    def _show_about(self):
        QMessageBox.about(self, "关于",
            "<b>E1_Master_Power_Manage 固件升级工具</b><br><br>"
            "基于 CANable 2.5 (USB-CAN) 的固件升级上位机（移植自 stm32_g474_boot）。<br><br>"
            "协议: 经典 CAN 8 字节帧 · 双分区 A/B 升级 · HW_ID=0x0002<br>"
            "文档: docs/boot_upgrade.md · docs/boot_migration.md<br>"
