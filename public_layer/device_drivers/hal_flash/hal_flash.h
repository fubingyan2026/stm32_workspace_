 ...
 *   HAL_FLASH_CHIP_STM32F1  — 选择 STM32F1 驱动 (1K 页, 32-bit 字)
 *
 * 锁策略:
 ...
 * 也可在下方手动取消注释。
 */
#if !defined(HAL_FLASH_CHIP_STM32F4) && !defined(HAL_FLASH_CHIP_STM32G4) && !defined(HAL_FLASH_CHIP_STM32H7) && !defined(HAL_FLASH_CHIP_STM32G0) && !defined(HAL_FLASH_CHIP_STM32F1)
/* 默认选择 H7，可根据项目修改 */
