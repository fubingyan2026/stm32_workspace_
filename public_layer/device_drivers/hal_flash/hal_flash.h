 ...
 *   HAL_FLASH_CHIP_STM32F1  — 选择 STM32F1 驱动 (2K 均匀页, 32-bit WORD 编程)
 ...
 * 也可在下方手动取消注释。
 */
#if !defined(HAL_FLASH_CHIP_STM32F1) && !defined(HAL_FLASH_CHIP_STM32F4) && !defined(HAL_FLASH_CHIP_STM32G4) && !defined(HAL_FLASH_CHIP_STM32H7) && !defined(HAL_FLASH_CHIP_STM32G0)
/* 默认选择 H7，可根据项目修改 */
